...
function createEmployee( res )
	employee = createPed(141, 359.7138, 173.6132, 1008.3893)

	setPedRotation(employee, 271)
...
function showJobUI( )
	...
	if (getData(localPlayer, "job") == 0) then 
		...
		guiGridListSetItemText(jobList, rows[1], 2, "Unity Station", false, false)
		guiGridListSetItemText(jobList, rows[2], 1, "Taxi Driver", false, false)
		guiGridListSetItemText(jobList, rows[2], 2, "Unity Station", false, false)
		guiGridListSetItemText(jobList, rows[3], 1, "Road Sweeper", false, false)
		guiGridListSetItemText(jobList, rows[3], 2, "Commerce", false, false)
		guiGridListSetItemText(jobList, rows[4], 1, "Oil Transporter", false, false)
		guiGridListSetItemText(jobList, rows[4], 2, "Vinewood Gas Station", false, false)
