...
local positions = { }
positions[1] = { 215.4453, 113.1845, 999.0156 }
positions[2] = { 219.7529, 113.1865, 999.0156 }
positions[3] = { 223.6552, 113.1845, 999.0156 }
positions[4] = { 227.4482, 113.1777, 999.0156 }
...
for key, value in ipairs ( positions ) do
	...
	setElementDimension(cells[key], 66)
end
	...
	if isElement( thePlayer ) then
		if ( arrests[thePlayer] ~= nil ) then -- He is arrested
			...
			if ( timeLeft == 1 ) then
				...
				setElementPosition(thePlayer, 1544.6943, -1675.2177, 13.5589)
				setElementRotation(thePlayer, 0, 0, 170)
