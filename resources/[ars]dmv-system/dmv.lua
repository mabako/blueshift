...
questions[6] = { }
questions[6][1] = { "What is the purpose of your horn?:", nil }
questions[6][2] = { "To ensure people are aware of your presence .", true }
questions[6][3] = { "To warn people to get out of the way.", false }
questions[6][4] = { "To say hello to your friends.", false }
...
function createEmployee( res )
	employee = createPed(147, -2034.6806, -118.1650, 1035.1718)
	
	setPedRotation(employee, 271)
	setElementInterior(employee, 3)
	setElementDimension(employee, 82)
end
