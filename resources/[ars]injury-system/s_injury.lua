...
function respawnPlayer( )
	spawnPlayer(source, 1521.4355, -1675.1318, 13.5468, 270, getElementModel( source ), 0, 0, getPlayerTeam( source ))
	...
	outputChatBox("You have recieved treatment from the Los Santos Medical Center.", source, 255, 255, 0)
end
