...
function displayLogin( changingAccount )
	...
	-- Display Background
	setCameraMatrix( 1431.7724, -1699.9765, 35.3394, 1238.2685, -1417.6318, 43.4597 )
...
function createUserInterface( )
	...
	--------- [ Information Elements ] ---------
	lblInfo_1 = guiCreateLabel(info_x, info_y, info_width, info_height, "Welcome to Blueshift Gaming! You need to login in order to", false, nil)
...
function displayAbout( button, state )
	if source == btnAbout and button == "left" and state == "up" then
		if guiGetText(source) == "About" then
			...
			lblAbout_1 = guiCreateLabel(lblabout_x, lblabout_y, lblabout_width + 110, lblabout_height, "About - Blueshift gaming", false, nil)
...
function displayInformation( button, state )
	if source == btnInformation and button == "left" and state == "up" then
		...
		if guiGetText(source) == "Information" then
			...
			lblInformation_1 = guiCreateLabel(lblinfo_x, lblinfo_y, lblinfo_width + 90, lblinfo_height, "Information - Blueshift Gaming", false, nil)
			lblInformation_2 = guiCreateLabel(lblinfo_x - 80, lblinfo_y + 20, lblinfo_width + 300, lblinfo_height, "Welcome to Blueshift Gaming, this is a roleplay server which", false, nil)
			...
			lblInformation_5 = guiCreateLabel(lblinfo_x - 80, lblinfo_y + 100, lblinfo_width + 300, lblinfo_height, "Blueshift Gaming presents its players with a totally fantastic", false, nil)
			...
			lblInformation_17 = guiCreateLabel(lblinfo_x - 80, lblinfo_y + 380, lblinfo_width + 300, lblinfo_height, "	- Blueshift Gaming Administration Team.", false, nil)
