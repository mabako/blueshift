...
local places = { 
	cityhall = { 1480.924, -1724.975, 13.547, 180 },
	airport =  { 1682.8681, -2246.2148, -2.6808, 176 },
	bank =     { 592.5957, -1237.5664, 17.9285, 200 },
	pd =       { 1521.4355, -1675.1318, 13.5468, 270 },
	hospital = { 1184.4873, -1324.9863, 13.5746, 270 },
	...
	if isElement( thePlayer ) then
		...
		if jails[thePlayer] then -- He is jailed
			...
			if tonumber(timeLeft) == 1 then
				...
				setElementDimension(thePlayer, 0)
				setElementInterior(thePlayer, 0)
				setElementPosition(thePlayer, 1521.4355, -1675.1318, 13.5468)
				setElementRotation(thePlayer, 270)
