...
local lines = { }
lines["Los Santos Police Department"] = 911
lines["San Andreas Network and Entertainment"] = 700
lines["Los Santos Vehicle Services"] = 300
lines["Los Santos Taxi Services"] = 500
						...
						if ( not found ) then
							...
							for key, value in pairs ( lines ) do
								if ( value == phoneNumber ) then
									...
									elseif ( key == "Los Santos Vehicle Services") then
										outputChatBox("Operator says: Hello, this is LSVS, What services do you require and where?", thePlayer, 212, 156, 49)
									elseif ( key == "Los Santos Taxi Services") then
										outputChatBox("Operator says: Hello, this is LSTS, Where would you like us to send a taxi?", thePlayer, 212, 156, 49)
									end	
								end
							end
					...
					for key, value in pairs ( lines ) do
						if ( key == tostring( getData(thePlayer, "calling") ) ) then
							...
							if ( key == "Los Santos Taxi Services" ) then
								...
								if ( key == "Los Santos Police Department" ) then
									for index, array in ipairs( getPlayersInTeam( getTeamFromName("Los Santos Emergency Services") ) ) do
