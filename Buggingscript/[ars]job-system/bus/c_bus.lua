...
function advanceCheckpoint( source )
	if (source == currMarker) then	-- Keep goin'
		...
		if (rand == 1 and stage == 37) or (rand == 2 and stage == 37) then -- Hit the third last checkpoint
			
			currR, currG, currB = 255, 194, 014	
			nextR, nextG, nextB = 255, 000, 000	-- The last marker is red :P
		elseif (rand == 1 and stage == 38) or (rand == 2 and stage == 38) then -- Hit the second last checkpoint
	...
	elseif (source == nextMarker) and (stage == 39) or (stage == 39) then -- End of the line
