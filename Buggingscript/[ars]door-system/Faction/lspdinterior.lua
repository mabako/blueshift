...
local function openDoor(thePlayer)
	if getElementDimension(thePlayer) == 66 and getElementInterior(thePlayer) == 10 and exports['[ars]inventory-system']:hasItem(thePlayer, 32) then
